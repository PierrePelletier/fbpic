...
@cuda.jit
def cuda_damp_a_left( a, dta, damp_array, n_guard, n_damp ):
    """
    Multiply the a and dta fields in the left guard cells
    by damp_array.

    Parameters :
    ------------
    a, dta: 2darrays of complexs
        Contain the fields to be damped
        The first axis corresponds to z and the second to r
    ...
    if ir < Nr :
        ...
        if iz < n_guard+n_damp:
            ...
            dta[iz, ir] *= damp_factor_left

@cuda.jit
def cuda_damp_EB_right( a, dta, damp_array, n_guard, n_damp ):
    """
    Multiply the a and dta fields in the right guard cells
    by damp_array.
    ...
    if ir < Nr :
        ...
        if iz < n_guard+n_damp:
            ...
            dta[iz_right, ir] *= damp_factor_right
